...
- [Rule: no-circular-dependencies](./docs/no-circular-dependencies.md)
- [Rule: no-catastrophic-regex](./docs/no-catastrophic-regex.md)
- [Rule: no-deep-clone-in-loop](./docs/no-deep-clone-in-loop.md)
- [Rule: no-n2-array-lookup](./docs/no-n2-array-lookup.md)
...
- [Rule: no-self-package-import](./docs/no-self-package-import.md)
- [Rule: no-regexp-construction-in-hot-path](./docs/no-regexp-construction-in-hot-path.md)
...
- [Rule: no-locale-format-in-hot-path](./docs/no-locale-format-in-hot-path.md)
- [Rule: no-layout-thrashing](./docs/no-layout-thrashing.md)
- [Rule: no-json-stringify-comparison](./docs/no-json-stringify-comparison.md)
- [Rule: no-lossy-error-serialization](./docs/no-lossy-error-serialization.md)
...
examples/
  ...
  noSelfPackageImport    # Example for importing a package by its own name
  noRegexpConstructionInHotPath # Example for RegExp construction in hot paths
  ...
  noLocaleFormatInHotPath # Example for locale formatting in hot paths
  noLayoutThrashing      # Example for layout thrashing
  noJsonStringifyComparison # Example for JSON.stringify equality checks
  noLossyErrorSerialization # Example for lossy error serialization
```
